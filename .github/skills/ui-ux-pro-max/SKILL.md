...
Leggere il MASTER e implementare seguendo le regole lì definite. Non richiamare lo script.
...
### Caso 3 — Aggiornare il MASTER (cambiamento globale stile)

```bash
cd /opt/TPZ/src/tbox/edge
python3 .github/prompts/ui-ux-pro-max/scripts/search.py \
  "fleet management SaaS dark dashboard satcom telespazio" \
  --design-system --persist -p "NOVA EDGE"
```
